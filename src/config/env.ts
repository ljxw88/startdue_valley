...
const numberEnvDefaults = {
  ...
  NEXT_PUBLIC_NPC_REPLAN_INTERVAL_TICKS: "12",
  NEXT_PUBLIC_NPC_MAX_REPLANS_PER_TICK: "2",
  NEXT_PUBLIC_NPC_THINK_BUDGET_MS: "200"
} as const;
...
const config = {
  ...
  NEXT_PUBLIC_NPC_REPLAN_INTERVAL_TICKS: parsePositiveInt(
    process.env.NEXT_PUBLIC_NPC_REPLAN_INTERVAL_TICKS ?? numberEnvDefaults.NEXT_PUBLIC_NPC_REPLAN_INTERVAL_TICKS,
    "NEXT_PUBLIC_NPC_REPLAN_INTERVAL_TICKS"
  ),
  NEXT_PUBLIC_NPC_MAX_REPLANS_PER_TICK: parsePositiveInt(
    process.env.NEXT_PUBLIC_NPC_MAX_REPLANS_PER_TICK ?? numberEnvDefaults.NEXT_PUBLIC_NPC_MAX_REPLANS_PER_TICK,
    "NEXT_PUBLIC_NPC_MAX_REPLANS_PER_TICK"
  ),
  NEXT_PUBLIC_NPC_THINK_BUDGET_MS: parsePositiveInt(
    process.env.NEXT_PUBLIC_NPC_THINK_BUDGET_MS ?? numberEnvDefaults.NEXT_PUBLIC_NPC_THINK_BUDGET_MS,
    "NEXT_PUBLIC_NPC_THINK_BUDGET_MS"
  )
} as const;
